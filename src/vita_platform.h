...
//
#if !defined(_GLFW_VITA_NO_CONTEXT_WRAPPER)
...
#define _GLFW_EGL_NATIVE_WINDOW  ((EGLNativeWindowType) window->vita.nwin)
#define _GLFW_EGL_NATIVE_DISPLAY EGL_DEFAULT_DISPLAY

#define _GLFW_PLATFORM_WINDOW_STATE         _GLFWwindowVita vita
#define _GLFW_PLATFORM_LIBRARY_WINDOW_STATE _GLFWlibraryVita vita
...
#include "vita_joystick.h"

#define _GLFW_VITA_EVENT_FOCUS_CHANGED       0x01
#define _GLFW_VITA_EVENT_SCREEN_SIZE_CHANGED 0x02

// Vita-specific per-window data
//
typedef struct _GLFWwindowVita
{
    int nwin;
    int width, height;
...
//
typedef struct _GLFWlibraryVita
{
...
// Vita-specific context management functions
//
